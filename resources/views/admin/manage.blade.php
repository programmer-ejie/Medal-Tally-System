...
<head>
  ...
  <!-- [Favicon] icon -->
  <link rel="icon" href="{{ asset('template/admin/dist/assets/images/favicon.svg') }}" type="image/x-icon"> <!-- [Google Font] Family -->
...
<tbody>
    <tr>
       <td>
            <span class="d-inline-flex align-items-center justify-content-center rounded-circle shadow-sm"
                style="background: linear-gradient(90deg, #e9ecef 60%, #f8f9fa 100%);padding: 5px; padding: 20px; color: #7d7d7d; width: 38px; height: 38px; font-weight: bold; margin: 10px; font-size: 1.2rem; border: 2px solid #C0C0C0;">
                <i class="ti ti-crown me-1" style="color: #C0C0C0; font-size: 1.1rem;"></i> 1
            </span>
        </td>
        <td>
            <img src="{{ asset('assets/images/teams/team1.png') }}" alt="Team Alpha Logo" width="40" height="40" class="rounded-circle">
        </td>
        <td>Team Alpha</td>
        <td>Engineering</td>
       <td>
            <span class="d-inline-flex align-items-center px-3 py-1 rounded-pill shadow-sm" style="background: linear-gradient(90deg, #ffe066 60%, #fffbe6 100%); color: #bfa100; font-weight: 600; font-size: 1rem;">
                <i class="ti ti-medal me-1" style="color: #6f6e69; font-size: 1.2rem;"></i> 5
            </span>
        </td>
        <td>
            <span class="d-inline-flex align-items-center px-3 py-1 rounded-pill shadow-sm" style="background: linear-gradient(90deg, #e9ecef 60%, #f8f9fa 100%); color: #7d7d7d; font-weight: 600; font-size: 1rem;">
                <i class="ti ti-medal me-1" style="color: #C0C0C0; font-size: 1.2rem;"></i> 3
            </span>
        </td>
        <td>
            <span class="d-inline-flex align-items-center px-3 py-1 rounded-pill shadow-sm" style="background: linear-gradient(90deg, #ffe5b4 60%, #fff8e1 100%); color: #a97142; font-weight: 600; font-size: 1rem;">
                <i class="ti ti-medal me-1" style="color: #cd7f32; font-size: 1.2rem;"></i> 2
            </span>
        </td>
        <td>
    ...
    <tr>
        <td>
            <span class="d-inline-flex align-items-center justify-content-center rounded-circle shadow-sm"
                style="background: linear-gradient(90deg, #e9ecef 60%, #f8f9fa 100%);padding: 5px; padding: 20px; color: #7d7d7d; width: 38px; height: 38px; font-weight: bold; margin: 10px; font-size: 1.2rem; border: 2px solid #C0C0C0;">
                <i class="ti ti-crown me-1" style="color: #C0C0C0; font-size: 1.1rem;"></i> 2
            </span>
        </td>
        <td>
            <img src="{{ asset('assets/images/teams/team2.png') }}" alt="Team Beta Logo" width="40" height="40" class="rounded-circle">
        </td>
        <td>Team Beta</td>
        <td>Science</td>
        <td>
    ...
    <tr>
       <td>
            <span class="d-inline-flex align-items-center justify-content-center rounded-circle shadow-sm"
                style="background: linear-gradient(90deg, #e9ecef 60%, #f8f9fa 100%);padding: 5px; padding: 20px; color: #7d7d7d; width: 38px; height: 38px; font-weight: bold; margin: 10px; font-size: 1.2rem; border: 2px solid #C0C0C0;">
                <i class="ti ti-crown me-1" style="color: #C0C0C0; font-size: 1.1rem;"></i> 3
            </span>
        </td>
        <td>
            <img src="{{ asset('assets/images/teams/team3.png') }}" alt="Team Gamma Logo" width="40" height="40" class="rounded-circle">
        </td>
        <td>Team Gamma</td>
        <td>Mathematics</td>
        <td>
